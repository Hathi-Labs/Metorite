...
- **D49 — Member invites: a NOTIFICATION email, a Console membership written at invite
  ...
  - **D49.1 — no accept-token, ever.** The invite email is a **notification**
    ...
    already written.
  - **D49.2 — the invite writes the Console-plane membership IMMEDIATELY,
  ...
  - **D49.3 — first sign-in auto-activates an `invited` member, guarded to `invited`
