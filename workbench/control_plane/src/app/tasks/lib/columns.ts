...
//
// D78 (2026-09-24): ONE "Priority" column, the matrix level, which is the
// task's shared level in both apps. D77 had two columns here, the old 0-3
// field as "Priority" and the matrix as "Your focus". That was two answers
// to one question, and the owner asked for one. `parseVisibility` ignores a
// stored `focus` key, and `priority` defaults to visible.
