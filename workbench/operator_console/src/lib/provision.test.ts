...
// ⚠️ **Deliberately LOW ENTROPY, and the word "notarealsecret" is the point.**
// The first draft of this file used a random-looking secret and gitleaks
// failed the PR on it — correctly. A fixture that looks like a credential
// teaches the secret gate to be ignored, which is the failure that matters
// more than this test does. `usage.test.ts` set this idiom.
const KEY = {
  prefix: "cc_live_fixture",
  token: "cc_live_fixture_notarealsecret",
};
